...
const Rejected = () => {
  ...
  const getpost = (
    ...
    axios
      .put("http://localhost:8080/api/v1/syncMedia/rejects", {
                ...
                {currentPosts
                  .filter((obj) => {
                    if (query == "") {
                      ...
                      obj.medianame.toLowerCase().includes(query.toLowerCase()) ||
                      obj.clientCode.toLowerCase().includes(query.toLowerCase()) ||
                      obj.syncstatus.toLowerCase().includes(query.toLowerCase())
                    ) {
                      return obj;
                    }
                  })
